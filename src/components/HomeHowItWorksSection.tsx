...
const HomeHowItWorksSection = () => (
  <section id="how-it-works" className="how-it-works bg-white pt-24 pb-4">
    <div className="container max-w-[1200px] mx-auto px-5">
      ...
      <div className="steps flex justify-between flex-wrap mt-15">
        <div className="step flex-1 min-w-[250px] text-center px-5 mb-10">
          ...
          <img
            src="/lovable-uploads/img/signup.png"
            alt="Sign up"
            className="h-16:10rem"
            />
            <div className="step-number w-12 h-12 rounded-full bg-[#1A237E] text-white font-bold text-xl flex items-center justify-center mx-auto m-2 ">1</div>
        ...
        <div className="step flex-1 min-w-[250px] text-center px-5 mb-10">
          ...
          <img
            src="/lovable-uploads/img/configuresetting.png"
            alt="Configure Settings"
            className="h-16:10rem"
            />
            <div className="step-number w-12 h-12 rounded-full bg-[#1A237E] text-white font-bold text-xl flex items-center justify-center mx-auto m-2">2</div>
        ...
        <div className="step flex-1 min-w-[250px] text-center px-5 mb-10">
          ...
          <img
            src="/lovable-uploads/img/forwardyournumber.png"
            alt="Forward Your Number"
            className="h-16:10rem"
            />
            <div className="step-number w-12 h-12 rounded-full bg-[#1A237E] text-white font-bold text-xl flex items-center justify-center mx-auto m-2">3</div>
        ...
        <div className="step flex-1 min-w-[250px] text-center px-5 mb-10">
          ...
          <img
            src="/lovable-uploads/img/golive.png"
            alt="Go Live"
            className="h-16:10rem"
            />
            <div className="step-number w-12 h-12 rounded-full bg-[#1A237E] text-white font-bold text-xl flex items-center justify-center mx-auto m-2">4</div>
