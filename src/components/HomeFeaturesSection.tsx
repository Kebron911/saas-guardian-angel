const HomeFeaturesSection = () => (
  <section id="features" className="features bg-white pt-24 pb-1 ">
    <div className="container max-w-[1200px] mx-auto px-5">
      ...
      <div className="features-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pt-0">
        <div className="feature-card bg-[#F5F5F5] rounded-lg p-8 transition-transform hover:translate-y-[-5px] hover:shadow-lg">
          <div className="feature-icon w-15 h-15 bg-[#FFF9C4] rounded-full flex items-center justify-center mb-5">
            ...
            */}
            <img
            src="/lovable-uploads/img/247availability.png"
        ...
        <div className="feature-card bg-[#F5F5F5] rounded-lg p-8 transition-transform hover:translate-y-[-5px] hover:shadow-lg">
          <div className="feature-icon w-15 h-15 bg-[#FFF9C4] rounded-full flex items-center justify-center mb-5">
           {/* <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <img
            src="/lovable-uploads/img/intelligentcallrouting.png"
            alt="Intelligent Call Routing"
            className="h-16:10rem"
            />
          </div>
        ...
        <div className="feature-card bg-[#F5F5F5] rounded-lg p-8 transition-transform hover:translate-y-[-5px] hover:shadow-lg">
          <div className="feature-icon w-15 h-15 bg-[#FFF9C4] rounded-full flex items-center justify-center mb-5">
            ...
            <img
            src="/lovable-uploads/img/naturalconversation.png"
        ...
        <div className="feature-card bg-[#F5F5F5] rounded-lg p-8 transition-transform hover:translate-y-[-5px] hover:shadow-lg">
          <div className="feature-icon w-15 h-15 bg-[#FFF9C4] rounded-full flex items-center justify-center mb-5">
            ...
            <img
            src="/lovable-uploads/img/professionalmessagetaking.png"
            alt="Professional Message Taking"
            className="h-16:10rem"
            />
          </div>
        ...
        <div className="feature-card bg-[#F5F5F5] rounded-lg p-8 transition-transform hover:translate-y-[-5px] hover:shadow-lg">
          <div className="feature-icon w-15 h-15 bg-[#FFF9C4] rounded-full flex items-center justify-center mb-5">
            ...
            <img
            src="/lovable-uploads/img/customizablescript.png"
            alt="Customizable Scripts"
            className="h-16:10rem"
            />
          </div>
        ...
        <div className="feature-card bg-[#F5F5F5] rounded-lg p-8 transition-transform hover:translate-y-[-5px] hover:shadow-lg">
          <div className="feature-icon w-15 h-15 bg-[#FFF9C4] rounded-full flex items-center justify-center mb-5">
            ...
            <img
            src="/lovable-uploads/img/callanalyticdashboard.png"
