      ...
      <div className="use-cases-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
        <div className="use-case-card bg-white rounded-lg p-8 shadow-md transition-transform hover:translate-y-[-5px]">
          <div className="use-case-icon w-15 h-15 bg-[#E3F2FD] rounded-full flex items-center justify-center mb-5">
            ...
            <img
            src="/lovable-uploads/img/homecasesimages/ProfessionalServices.png"
        ...
        <div className="use-case-card bg-white rounded-lg p-8 shadow-md transition-transform hover:translate-y-[-5px]">
          <div className="use-case-icon w-15 h-15 bg-[#E3F2FD] rounded-full flex items-center justify-center mb-5">
            {/* <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
             ...
             <img
            src="/lovable-uploads/img/homecasesimages/MedicalPractices.png"
        ...
        <div className="use-case-card bg-white rounded-lg p-8 shadow-md transition-transform hover:translate-y-[-5px]">
          <div className="use-case-icon w-15 h-15 bg-[#E3F2FD] rounded-full flex items-center justify-center mb-5">
            ...
            <img
            src="/lovable-uploads/img/homecasesimages/RealEstateOffice.png"
            alt="Real Estate Offices"
            className="h-16:10rem"
            />
          </div>
        ...
        <div className="use-case-card bg-white rounded-lg p-8 shadow-md transition-transform hover:translate-y-[-5px]">
          <div className="use-case-icon w-15 h-15 bg-[#E3F2FD] rounded-full flex items-center justify-center mb-5">
            ...
            <img
            src="/lovable-uploads/img/homecasesimages/SmallBusiness.png"
        ...
        <div className="use-case-card bg-white rounded-lg p-8 shadow-md transition-transform hover:translate-y-[-5px]">
          <div className="use-case-icon w-15 h-15 bg-[#E3F2FD] rounded-full flex items-center justify-center mb-5">
            ...
            <img
            src="/lovable-uploads/img/homecasesimages/ECommerceBusiness.png"
            alt="E-commerce Businesses"
            className="h-16:10rem"
            />
          </div>
        ...
        <div className="use-case-card bg-white rounded-lg p-8 shadow-md transition-transform hover:translate-y-[-5px]">
          <div className="use-case-icon w-15 h-15 bg-[#E3F2FD] rounded-full flex items-center justify-center mb-5">
            ...
            <img
            src="/lovable-uploads/img/homecasesimages/HomeServicesProvider.png"
